...
I am an LKHITECH Inline Saver Bot, you can save inline filters and It can be use in any of your chats easily, Click help for more details</b> 
"""
...
○ Channel : <a href='https://t.me/lkhitech'>LKHITECH</a>
○ Support : <a href='https://t.me/hitechlkgroup'>LKHITECH Support</a>
○ Websit : <a href='www.lkhitech.blogspot.com'>Click here</a>
○ Youtube Channel : <a href='www.youtube.com/c/KavinduAj'>Click here</a>
...
○ <b>Hyper Link</b>
    format: <code>[Text](https://t.me/lkhitech)</code>
    show as: <a href='https://t.me/lkhitech'>Text</a>
    
○ <b>Buttons</b>
    <u>Url Button</u>:
    <code>[Button Text](buttonurl:https://t.me/lkhitech)</code>
    <u>Alert Button</u>:
    <code>[Button Text](buttonalert:Alert Text)</code>
    <u>In Sameline</u>:
    <code>[Button Text](buttonurl:https://t.me/lkhitech:same)</code></i>
