...
thumb = os.environ.get('THUMBNAIL_URL', 'https://telegra.ph/file/dc8629abf0fbc5dfbe732.jpg')
...
class CodeXBotz(Client):
    ...
    async def start(self):
        ...
        self.LOGGER(__name__).info("Created by LKHITECH\nhttps://t.me/lkhitech")
